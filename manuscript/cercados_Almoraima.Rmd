...
ggplot2::ggsave(file.path(root, "manuscript", "cercados_Almoraima", "Fig1.tif"), map, 
...
ggplot2::ggsave(file.path(root, "manuscript", "cercados_Almoraima", "Fig2.tif"), height, 
...
ggplot2::ggsave(file.path(root, "manuscript", "cercados_Almoraima", "Fig3.tif"), plantcover, 
       device = "tiff", width = 6, height = 5, units = "in", dpi = 300, compression = "lzw")
```
...
ggplot2::ggsave(file.path(root, "manuscript", "cercados_Almoraima", "Fig4.tif"), nsp, 
       device = "tiff", width = 6, height = 5, units = "in", dpi = 300, compression = "lzw")
```
...
ggplot2::ggsave(file.path(root, "manuscript", "cercados_Almoraima", "Fig5.tif"), fig, 
...
ggplot2::ggsave(file.path(root, "manuscript", "cercados_Almoraima", "Fig6.tif"), ggout, 
       device = "tiff", width = 6, height = 7, units = "in", dpi = 300, compression = "lzw")
```
...
ggplot2::ggsave(file.path(root, "manuscript", "cercados_Almoraima", "Fig7.tif"), cover, 
...
ggplot2::ggsave(file.path(root, "manuscript", "cercados_Almoraima", "Fig8.tif"), fig, 
       device = "tiff", width = 6, height = 7, units = "in", dpi = 300, compression = "lzw")
```
...
ggplot2::ggsave(file.path(root, "manuscript", "cercados_Almoraima", "Fig9.tif"), damage, 
